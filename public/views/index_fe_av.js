        ...
        children: [
            {
                ...
                children: [
                    ...
                    //{leaf: true, text: 'Site Find', iconCls: 'fa fa-search', path: 'findsite'},
                    {leaf: true, text: 'Site FCD - FE', iconCls: 'fa fa-check-circle', path:'checkdate'},
                    //{leaf: true, text: 'Site Login Checking', iconCls: 'fa fa-check-circle', path:'checklogin'},
                    {leaf: true, text: 'Tracking Deployment', iconCls: 'fa fa-check-circle', path:'user_deploy_statistic'},
                    {leaf: true, text: 'Log Task', iconCls: 'fa fa-check-circle', path:'site_log_task'}
                ]
            }/*, {
                text: 'WL Management',
                iconCls: 'fa fa-users',
...
Ext.application({
    ...
    launch: function () {
        var tab = getCmp('#tpMain').add({
            xtype: "component",
            title: 'Site Find Check Deploy - FE',
