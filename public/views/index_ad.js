        ...
        children: [
            {
                ...
                iconCls: 'fa fa-bomb',
                children: [
                    {leaf: true, text: 'User Management', path: 'user_manage', iconCls: 'fa fa-users'},
                    {leaf: true, text: 'Statistic Finding', path: 'user_find_statistic', iconCls: 'fa fa-users'},
                    {leaf: true, text: 'Statistic Deploy', path: 'user_deploy_statistic', iconCls: 'fa fa-users'}
                ]
            },
            /*, {
                ...
                children: [
                    ...
                    {leaf: true, text: 'Site Testing Deploy', iconCls: 'fa fa-check-circle', path:'testsite'}
                ]
            }, {
